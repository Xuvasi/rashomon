    ...
    makeDraggable: function () {
        $(".vidtime").draggable({
                ...
                drag: function (event, ui) {
                    ...
                    } else if ($(this).parent().width() - (ui.position.left + $(this).width()) < 10) {
...
//last freehanging function because it needs a rewrite
