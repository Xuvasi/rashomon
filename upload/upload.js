...
DndUpload.prototype.buildDropZone = function() {
    ...
    this.dropZone.addEventListener('dragenter', function(e){ self.handleDragEnter.call(self,e) } , false);
    this.dropZone.addEventListener('drop', function(e){ self.handleDrop.call(self,e) }, false);
    
    this.dropZone.addEventListener('dragleave', function(e){ self.handleDragLeave.call(self,e) } , false);
};
...
FileUpload.prototype.buildUploader = function(){
   ...
   this.progressBarPercent.value = '0';*/
    ...
    this.btnCancel.addEventListener('click', function(e){ self.cancelUpload.call(self, e)}, false);
...
FileUpload.prototype.sendDatas = function(fileDatas) {
    ...
    if ( this.xhr ){
        this.xhr.upload.addEventListener("progress", function(e){ self.updateProgress.call(self, e) }, false);
        this.xhr.addEventListener("load", function(){ self.endUpload.call(self) }, false);
        this.xhr.addEventListener("abort", function(){ self.closeXhr(self) }, false);
        document.body.addEventListener('offline', function(){ self.endProcess(0) }, false);
